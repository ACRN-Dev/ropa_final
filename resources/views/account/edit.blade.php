...
<div class="min-h-screen bg-gray-50">
    ...
    <nav class="bg-white shadow-md mb-6">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-3">
                ...
                <h1 class="text-xl font-bold text-indigo-700"></h1>
            </div>
    ...
    <div class="container mx-auto p-6">
        ...
        <h2 class="text-2xl font-bold mb-6 text-indigo-700 flex items-center">
            <i data-feather="settings" class="w-6 h-6 mr-2"></i> Account Settings
        </h2>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-white shadow-lg rounded-lg p-6">
                <h3 class="text-lg font-semibold text-gray-700 mb-4 flex items-center">
                    <i data-feather="user" class="w-5 h-5 mr-2"></i> Profile Information
                </h3>
                ...
                <form method="POST" action="{{ route('profile.update') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="department" name="department" value="{{ old('department', auth()->user()->department) }}"
                            ...
                            class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none @error('department') border-red-500 @enderror">
                        @error('department')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="job_title" name="job_title" value="{{ old('job_title', auth()->user()->job_title) }}"
                            placeholder="Optional"
                            class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none @error('job_title') border-red-500 @enderror">
                        @error('job_title')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex justify-end mt-4">
                        <button type="submit" class="flex items-center bg-indigo-600 text-white px-5 py-2 rounded-lg hover:bg-indigo-700 transition">
            ...
            <div class="bg-white shadow-lg rounded-lg p-6">
                <h3 class="text-lg font-semibold text-gray-700 mb-4 flex items-center">
                    <i data-feather="lock" class="w-5 h-5 mr-2"></i> Change Password
                </h3>
                ...
                <form method="POST" action="{{ route('password.update') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="password" id="current_password" name="current_password"
                            class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none @error('current_password') border-red-500 @enderror" required>
                    ...
                    <div>
                        ...
                        <input type="password" id="password" name="password"
                            class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none @error('password') border-red-500 @enderror" required>
                        @error('password')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="password" id="password_confirmation" name="password_confirmation"
                            class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none @error('password_confirmation') border-red-500 @enderror" required>
                    ...
                    <!-- Update Password -->
                    <div class="flex justify-end mt-4">
                        <button type="submit" class="flex items-center bg-green-600 text-white px-5 py-2 rounded-lg hover:bg-green-700 transition">
                ...
                <div class="mt-6">
                    <span class="text-red-700 font-semibold">Two-Factor Authentication (2FA)</span>
                    <form method="POST" action="{{ route('2fa.toggle') }}" class="mt-2 relative">
                        ...
                        <label for="2fa-toggle" class="flex items-center cursor-pointer relative">
                            ...
                            <div class="w-12 h-6 bg-gray-300 rounded-full peer-checked:bg-indigo-600 transition-colors duration-300"></div>
