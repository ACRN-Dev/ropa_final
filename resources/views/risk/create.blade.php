...
<div class="container mx-auto px-4 py-6 max-w-6xl">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-orange-600 mb-2">Create New Risk</h1>
        <p class="text-gray-600">Add a new risk to the enterprise risk register</p>
    </div>
    ...
    <form action="{{ route('risk-register.store') }}" method="POST" class="bg-white rounded-xl shadow-md p-8 space-y-8">
        @csrf
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           id="department"
                           name="department" 
                           value="{{ old('department', auth()->user()->department ?? 'Not Assigned') }}" 
                ...
                <div>
                    ...
                    <select name="risk_category" 
                        ...
                        @foreach(['Strategic', 'Operational', 'Financial', 'Compliance', 'Technology', 'Reputational', 'Data Privacy', 'Security'] as $category)
                            <option value="{{ $category }}" {{ old('risk_category') == $category ? 'selected' : '' }}>
                                {{ $category }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="grid md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <select name="likelihood" 
                        ...
                        <option value="1" {{ old('likelihood') == '1' ? 'selected' : '' }}>1 - Rare</option>
                        <option value="2" {{ old('likelihood') == '2' ? 'selected' : '' }}>2 - Unlikely</option>
                        <option value="3" {{ old('likelihood') == '3' ? 'selected' : '' }}>3 - Possible</option>
                        <option value="4" {{ old('likelihood') == '4' ? 'selected' : '' }}>4 - Likely</option>
                        <option value="5" {{ old('likelihood') == '5' ? 'selected' : '' }}>5 - Almost Certain</option>
                    </select>
                ...
                <div>
                    ...
                    <select name="impact" 
                            ...
                            required>
                        <option value="">-- Select --</option>
                        <option value="1" {{ old('impact') == '1' ? 'selected' : '' }}>1 - Insignificant</option>
                        <option value="2" {{ old('impact') == '2' ? 'selected' : '' }}>2 - Minor</option>
                        <option value="3" {{ old('impact') == '3' ? 'selected' : '' }}>3 - Moderate</option>
                        <option value="4" {{ old('impact') == '4' ? 'selected' : '' }}>4 - Major</option>
                        <option value="5" {{ old('impact') == '5' ? 'selected' : '' }}>5 - Catastrophic</option>
                    </select>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="current_controls" 
                              ...
                              rows="4"
                              class="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                              placeholder="Describe existing controls, measures, or safeguards currently in place">{{ old('current_controls') }}</textarea>
                </div>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="mitigation_plan" 
                              ...
                              rows="4"
                              class="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                              placeholder="Describe planned actions to reduce or eliminate this risk">{{ old('mitigation_plan') }}</textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="action" 
                              ...
                              rows="3"
                              class="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                              placeholder="List specific action items or steps to be taken">{{ old('action') }}</textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="expected_response" 
                              ...
                              rows="3"
                              class="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                              placeholder="What outcome do you expect from the mitigation plan?">{{ old('expected_response') }}</textarea>
                </div>
